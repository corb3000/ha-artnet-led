...
Alternatively, manual installation by downloading the [custom_components/artnet-led](custom_components/artnet-led) directory to the *custom_components/artnet-led* directory on your Home Assistant instance (generally */config/custom_components/artnet-led*).
